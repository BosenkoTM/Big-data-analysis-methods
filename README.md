...
```mermaid
flowchart TD
    A[Мини-лекции<br/>Big Data, Data Quality, CRISP-DM, ML и NLP]
    --> B[Выбор индивидуального варианта 1–25]

    B --> C[ЛР 1<br/>Сбор, очистка и EDA]
    C --> D[ЛР 2<br/>K-Means и прогнозирование успешности]
    D --> E[ЛР 3<br/>NLP, TF-IDF, LDA и классификация]

    E --> F[Междисциплинарный проект<br/>AI & English]
    F --> G[Методическая интерпретация<br/>Data Science для 10–11 классов]

    C --> H[Промежуточный тест<br/>Разделы 1–2]
    G --> I[Итоговый тест<br/>Разделы 3–5]

    H --> J[Накопление баллов БРС]
    I --> J
    J --> K[Итоговая аттестация]
```
